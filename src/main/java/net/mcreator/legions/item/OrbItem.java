...
public class OrbItem extends LegionsModElements.ModElement {
	@ObjectHolder("legions:orb")
	public static final Item block = null;
	@ObjectHolder("legions:entitybulletorb")
	public static final EntityType arrow = null;
	public OrbItem(LegionsModElements instance) {
		super(instance, 26);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletorb").setRegistryName("entitybulletorb"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(OrbbulletItem.block, (int) (1));
		}
